...
using Shouldly;
using Xunit;
using react-core-boilerplate.Sessions;

namespace react-core-boilerplate.Tests.Sessions
{
    public class SessionAppService_Tests : react-core-boilerplateTestBase
    {
